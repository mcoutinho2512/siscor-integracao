...
urlpatterns = [
    ...
    path('api/ocorrencias/', views.ocorrencias_view, name='api_ocorrencias'),
    path('api/eventos/', views.eventos_view, name='api_eventos'),
    path('api/ventos/', views.ventos_api, name='api_ventos'),
    path('api/waze/', views.waze_api, name='api_waze'),
    ...
    # APIs - Eventos e Ocorrências
            # ✅ Nova API de ocorrências de hoje
    ...
    path('api/cameras/', views.cameras_api_local, name='cameras_api'),
        ...
        # Manter compatibilidade com URLs antigas (retornar erro amigável)
